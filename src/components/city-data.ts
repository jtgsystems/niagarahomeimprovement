...
export const cityList: CityData[] = [
  {
    ...
    seoDescription:
      "Find trusted home improvement contractors in St. Catharines, Ontario. Renovations, repairs, and specialized services from verified local professionals.",
    description:
      "The largest city in the Niagara Region and a hub for residential renovation and new construction.",
    longDescription:
    ...
    highlights: [
      "Garden City with diverse housing stock",
      "Brock University area developments",
      "Downtown heritage home restorations",
      "Growing suburban new-build market",
    ],
  },
  {
    name: "Niagara Falls",
    ...
    seoDescription:
      "Top-rated home improvement contractors in Niagara Falls, Ontario. Kitchen renovations, bathroom remodels, roofing, and more. Get listed today.",
    description:
      "World-famous tourism destination with a strong residential renovation market.",
    longDescription:
    ...
    highlights: [
      "Tourism economy driving property investment",
      "Stamford and Chippawa neighborhoods",
      "Energy-efficient home upgrade demand",
      "Strong rental property renovation market",
    ],
  },
  {
    name: "Welland",
    ...
    seoDescription:
      "Professional home improvement services in Welland, Ontario. Find verified contractors for renovations, repairs, and new construction projects.",
    description:
      "A growing city with affordable housing and strong demand for renovation services.",
    longDescription:
    ...
    highlights: [
      ...
      "Strong demand for modernization",
      "Growing new subdivision market",
    ],
  },
  {
    name: "Thorold",
    ...
    seoDescription:
      "Find skilled home improvement contractors in Thorold, Ontario. Renovations, landscaping, roofing, and specialty trades. Add your business today.",
    description:
      "A community with rich heritage homes and new developments along the canal.",
    longDescription:
    ...
    highlights: [
      "Heritage stone home restorations",
      "Brock University rental market",
      "Welland Canal corridor development",
      "Family-oriented renovation demand",
    ],
  },
  {
    ...
    seoDescription:
      "Premium home improvement contractors in Niagara-on-the-Lake. Heritage restorations, luxury renovations, and estate maintenance. Get listed.",
    description:
      "A prestigious community known for heritage homes, wineries, and luxury properties.",
    longDescription:
    ...
    highlights: [
      "Heritage district preservation projects",
      "Luxury estate renovations",
      "Winery and vineyard properties",
      "Premium craftsmanship demand",
    ],
  },
  {
    name: "Fort Erie",
    ...
    seoDescription:
      "Trusted home improvement contractors in Fort Erie, Ontario. Waterfront properties, renovations, and seasonal home maintenance. List your business.",
    description:
      "A border town with waterfront properties and growing residential investment.",
    longDescription:
    ...
    highlights: [
      ...
      "Crystal Beach cottage conversions",
      "Cross-border real estate investment",
      "Seasonal to year-round home upgrades",
    ],
  },
  {
    name: "Grimsby",
    ...
    seoDescription:
      "Quality home improvement contractors in Grimsby, Ontario. Escarpment properties, renovations, and custom builds. Add your contracting business.",
    description:
      "An upscale community along the Niagara Escarpment with premium housing.",
    longDescription:
    ...
    highlights: [
      "Escarpment-view custom homes",
      "Premium renovation budgets",
      "GTA commuter market",
      "Upscale outdoor living projects",
    ],
  },
  {
    name: "Lincoln",
    ...
    seoDescription:
      "Home improvement professionals in Lincoln, Ontario (Beamsville, Vineland, Jordan). Renovations, agricultural builds, and residential services.",
    description:
      "A wine country community including Beamsville, Vineland, and Jordan.",
    longDescription:
    ...
    highlights: [
      "Wine country estate properties",
      "Beamsville suburban growth",
      "Rural and agricultural buildings",
      "Heritage village restorations",
    ],
  },
  {
    name: "Pelham",
    ...
    seoDescription:
      "Home improvement contractors in Pelham, Ontario (Fonthill, Fenwick). Residential renovations, custom builds, and outdoor living. Get listed.",
    description:
      "A family-friendly town including Fonthill and Fenwick with strong residential demand.",
    longDescription:
    ...
    highlights: [
      "Family-oriented renovation projects",
      "Fonthill downtown area upgrades",
      "Short Hills premium properties",
      "Strong community investment in homes",
    ],
  },
  {
    name: "Port Colborne",
    ...
    seoDescription:
      "Skilled home improvement contractors in Port Colborne, ON. Waterfront renovations, residential repairs, and commercial services. List your business.",
    description:
      "A lakeside city with canal heritage and growing residential interest.",
    longDescription:
    ...
    highlights: [
      ...
      "Welland Canal heritage area",
      "Affordable renovation opportunities",
      "Growing tourism-related demand",
    ],
  },
  {
    name: "Wainfleet",
    ...
    seoDescription:
      "Home improvement and rural property contractors in Wainfleet, Ontario. Agricultural buildings, renovations, and lakeside properties. Add your business.",
    description:
      "A rural township with agricultural properties and lakeside cottages.",
    longDescription:
    ...
    highlights: [
      ...
      "Long Beach cottage renovations",
      "Rural property modernization",
      "Country home energy upgrades",
    ],
  },
  {
    name: "West Lincoln",
    ...
    seoDescription:
      "Home improvement contractors in West Lincoln, ON (Smithville). Rural renovations, new builds, and agricultural services. Get your business listed.",
    description:
      "A growing rural municipality centered around Smithville with new development.",
    longDescription:
    ...
    highlights: [
      "Smithville subdivision boom",
      "Rural estate custom builds",
      "Agricultural property services",
      "Fast-growing residential market",
    ],
  },
];
